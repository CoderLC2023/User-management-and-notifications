  ...
  <div class="main">
    ...
    >
      ...
      >
        ...
        <a-tab-pane key="tab2" tab="Email">
          <a-form-item>
            <a-input size="large" type="text" placeholder="Email" v-decorator="['mobile', {rules: [{ required: true, pattern: /^1[34578]\d{9}$/, message: $t('user.login.mobile.placeholder') }], validateTrigger: 'change'}]">
